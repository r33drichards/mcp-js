// GENERATED bundle: feross/buffer 6.0.3 + base64-js 1.5.1 (MIT) +
// ieee754 1.2.1 (BSD-3-Clause), wrapped as one ESM module for node:buffer.
// See tools/compat/gen-node-modules.py's sibling vendoring notes.
const __modules = {};
function __req(id) {
  const m = __modules[id];
  if (!m.exports) { m.exports = {}; m.factory(m, m.exports, __req); }
  return m.exports;
}
__modules['base64-js'] = { factory(module, exports, require) {
'use strict'
...
__modules['base64-js'].exports = module.exports;
} };
__modules['ieee754'] = { factory(module, exports, require) {
...
__modules['ieee754'].exports = module.exports;
} };
__modules['buffer'] = { factory(module, exports, require) {
/*!
...
Buffer.prototype.inspect = function inspect (_depth, options, inspectValue) {
  ...
  const props = Object.keys(this)
    ...
    .map((key) => {
      const value = typeof inspectValue === 'function'
        ? inspectValue(this[key], options)
        : String(this[key])
      return key + ': ' + value
    })
...
__modules['buffer'].exports = module.exports;
} };
const __buf = __req('buffer');
export const Buffer = __buf.Buffer;
export const SlowBuffer = __buf.SlowBuffer;
export const INSPECT_MAX_BYTES = __buf.INSPECT_MAX_BYTES;
export const kMaxLength = __buf.kMaxLength;
export const constants = { MAX_LENGTH: __buf.kMaxLength, MAX_STRING_LENGTH: (1 << 29) - 24 };
const bufferModule = { Buffer, SlowBuffer, kMaxLength, constants };
Object.defineProperty(bufferModule, 'INSPECT_MAX_BYTES', {
  enumerable: true,
  get() { return __buf.INSPECT_MAX_BYTES; },
  set(value) { __buf.INSPECT_MAX_BYTES = value; },
});
