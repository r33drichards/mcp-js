...
use fetch_headers::load_fetch_header_rules;
...
#[cfg(test)]
mod tests {
    use super::{load_mcp_server_configs, load_wasm_modules, resolve_text_or_file};
    use crate::fetch_headers::{load_fetch_header_rules, parse_fetch_header_cli};
    ...
    fn parse_fetch_header_cli_rejects_unknown_key() {
        ...
        assert!(message.contains(&crate::cli::FetchHeaderKey::expected()));
    }
