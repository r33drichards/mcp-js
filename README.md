...
- **Kernel-enforced confinement.** Opt-in [`--sandbox`](https://r33drichards.github.io/mcp-js/concepts/os-sandbox/) confines the whole process with [nono](https://github.com/nolabs-ai/nono) (Landlock on Linux, Seatbelt on macOS) as defense in depth beneath the policy layer.
