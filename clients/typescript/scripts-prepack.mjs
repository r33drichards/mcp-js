...
for (const file of ['dist/index.js', 'dist/index.d.ts', 'dist/schema.d.ts', 'LICENSE']) {
...
assert.match(readFileSync('LICENSE', 'utf8'), /^MIT License\n\nCopyright \(c\) 2025 Robert Wendt\n/m, 'HTTP package must carry its approved MIT license');
